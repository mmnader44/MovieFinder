...
with tab3:
    ...
    sns.histplot(df['startYear'], bins=30, kde=True, ax=ax)
    ...
    fig, ax = plt.subplots(figsize=(10, 6))
    sns.histplot(df['averageRating'], bins=20, kde=True, ax=ax)
    ...
    fig, ax = plt.subplots(figsize=(10, 6))
    df['genres'].str.split(',').explode().value_counts().plot(kind='bar', ax=ax)
